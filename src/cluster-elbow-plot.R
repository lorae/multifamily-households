...
# Elbow plot
elbow_path <- file.path(out_dir, paste0("fig05_elbow_plot_", timestamp, ".png"))
...
# Elbow table 
csv_path <- file.path(out_dir, paste0("fig05_elbow_plot_", timestamp, ".csv"))
write_csv(elbow_df, csv_path)
message("✅ Elbow data saved to: ", csv_path)

# All k-means results
rds_path <- file.path(out_dir, paste0("k1_k15_results", timestamp, ".rds"))
